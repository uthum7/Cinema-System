      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/10">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="group w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl font-bold text-lg shadow-lg shadow-purple-500/50 hover:shadow-purple-500/80 transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2"
            >
              <span>Sign In</span>
